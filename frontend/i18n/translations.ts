...
export const translations: Translations = {
    zh: {
        ...
        "save": "保存",
        "cancel": "取消",
        "settings_desc": "Telegram 多账号自动化批量签到任务管理面板",
        "settings_title": "系统设置",
        "logout": "退出登录",
        "connected": "已连接",
        ...
        "proxy": "SOCKS5 代理 (可选)",
        "proxy_placeholder": "socks5://ip:port 或 socks5://ip:port:user:pass",
        "confirm_connect": "确认保存",
        "proxy_test": "测试连通性",
        "proxy_testing": "测试中...",
        "proxy_test_success": "代理连通测试成功",
        "proxy_test_failed": "代理无法连接",
        "clear_proxy": "清除代理",
        "proxy_cleared": "代理已清除",
    ...
    "fixed_time_cron": "固定时间",
    "sign_time_cron": "签到时间",
    "cron_example": "每天会在该时间自动执行",
        ...
        "data_dir": "数据目录",
        "data_dir_placeholder": "例如: /opt/tg-pilot-data",
    ...
    en: {
        ...
        "save": "Save",
        "cancel": "Cancel",
        "settings_desc": "Telegram Multi-Account Automation & Bulk Sign-in Task Management Panel",
        ...
        "account_status_unknown": "Not Checked",
        ...
        "proxy_placeholder": "socks5://ip:port or socks5://ip:port:user:pass",
        "confirm_connect": "Confirm Save",
        "proxy_test": "Test Connection",
        "proxy_testing": "Testing...",
        "proxy_test_success": "Proxy connection successful",
    ...
    "fixed_time_cron": "Fixed Time",
    "sign_time_cron": "Sign-in Time",
    "cron_example": "Runs automatically every day at this time",
        ...
        "data_dir_placeholder": "e.g. /opt/tg-pilot-data",
